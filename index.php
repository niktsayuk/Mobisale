...
<html lang="en">
  ...
  <!-- Header -->
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
      <div class="container">
        ...
        <div class="d-flex ">
          <a href="signin.php" class="btn btn-outline-success">Войти</a>
        </div>
      </div>
    </nav>
  <!-- Header -->
  ...
  <!-- Modal #SignIn -->
    <div class="modal fade" id="SignIn" tabindex="-1" aria-bs-labelledby="SignInLabel" aria-bs-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title" id="SignInLabel">Авторизация</h4>
            <button class="btn btn-close" data-bs-dismiss="modal" aria-bs-label="close"></button>
          </div>
  ...
  <!-- Block register -->
        <div class="row  bg-light mt-5 p-5">
          ...
          <div class="col-md-4 p-3">
            <h2 class="text-center">Зарегистрируйся!</h2>
            <p class="text-center">Чтобы совершать самые выгодные покупки на нашем сайте!</p>
            ...
            <div class="d-flex ">
              <button class="btn btn-outline-success mt-3" type="submit">Зарегистрироваться</button>
            </div>
